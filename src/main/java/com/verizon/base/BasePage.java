...
public class BasePage {
	...
	public Properties initialize_properties(){
	 ...
	 try{
	 FileInputStream ip = new FileInputStream("/Users/nurapaydin/Documents/workspace/TestNGFrameworkVerizon/src/main/java/config/verizon/config/config.properties");
